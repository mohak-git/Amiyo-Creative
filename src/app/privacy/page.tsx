...
export const metadata: Metadata = {
    ...
    description: "Privacy Policy for Amiyo Creative. Learn how we collect, use, and protect your data.",
};
            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>
                            If you have any questions about this privacy policy or our privacy practices, please contact us at: <a href="mailto:contact@amiyocreative.com" className="text-purple-400 hover:text-purple-300 transition-colors">contact@amiyocreative.com</a>.
                        </p>
                    </section>
                </div>
            </div>
