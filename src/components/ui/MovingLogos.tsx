...
function MovingLogos() {
    ...
    return (
        <div className="w-full flex justify-center items-center px-4 sm:px-10 3xl:px-30">
            ...
            >
                <div className="pointer-events-none absolute top-0 left-0 w-60 h-full bg-linear-to-r from-gray-950 via-gray-950/60 to-transparent z-10"></div>
                <div className="pointer-events-none absolute top-0 right-0 w-60 h-full bg-linear-to-l from-gray-950 via-gray-950/60 to-transparent z-10"></div>
