...
import { BLOG_HERO } from "@/constants/blogData";
import { motion } from "framer-motion";

export default function BlogHero() {
    return (
        <section className="relative w-full py-12 md:py-16 x-6 flex flex-col items-center justify-center text-center z-10">
            {/* Background elements if any, can be added here or in parent */}
            ...
            <div className="absolute inset-0 -z-10 overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-[300px] h-[300px] bg-blue-600/10 rounded-full blur-[80px]" />
            </div>
        </section>
    );
}
