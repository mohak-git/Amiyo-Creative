...
export default function BlogCategory({ category, index }: BlogCategoryProps) {
    return (
        <section className="w-full py-16 px-6 max-w-7xl mx-auto">
            <div className="mb-12">
                <div className="flex items-center gap-4 mb-4">
                    <span className="h-px bg-foreground/20 flex-grow max-w-[50px]" />
                    <h2 className="text-2xl md:text-3xl font-bold text-foreground tracking-wide">
                        {category.title.toUpperCase()}
                    </h2>
                    <span className="h-px bg-foreground/20 flex-grow" />
                </div>
