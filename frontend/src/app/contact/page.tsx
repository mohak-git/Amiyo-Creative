...
const Contact = () => {
    return (
        <main className="md:pt-[10vh]">
            <div className="pt-[6vh] relative bg-gradient-to-b from-transparent to-slate-950 text-white overflow-hidden">
                {/* --- Background --- */}
                ...
                <div className="relative z-20 container mx-auto p-4">
                    <div className="grid px-6 sm:px-10 3xl:px-30 lg:grid-cols-3 gap-12 mx-auto">
                        <ContactForm />
                        <ContactInfo />
                    </div>

                    <div className="px-6 sm:px-10 3xl:px-30 mx-auto rounded-2xl overflow-hidden shadow-lg border border-white/10 mt-12">
                        <iframe
