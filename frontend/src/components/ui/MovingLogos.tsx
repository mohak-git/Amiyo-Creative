    ...
    return (
        <div className="w-full flex justify-center items-center px-4 sm:px-10 3xl:px-30">
            <motion.div
                ...
                className="relative w-full py-4 md:py-6 lg:py-8 z-5 overflow-hidden bg-gradient-to-r from-transparent via-indigo-700/30 to-transparent backdrop-blur-lg"
            >
